...
const Taxonomies = ({
  ...
  <Nav navbar pullLeft className="navbar-iconic" {...props}>
        ...
        {organizations.map((organization, i) => (
          <li key={i}>
            <a
              ...
              onClick={() => onOrgClick(organization.id, organization.title)}
            >
              {__(organization.title)}
            </a>
          </li>
        ))}
      </ul>
    ...
    <NavItem className="dropdown org-switcher" id="location-dropdown">
      ...
      <ul className="dropdown-menu">
        <li className="dropdown-header">Location</li>
        <li>
        ...
        {locations.map((location, i) => (
          <li key={i}>
            <a
              ...
              href={location.href}
              onClick={() => onLocationClick(location.id, location.title)}
            >
              {__(location.title)}
            </a>
          </li>
