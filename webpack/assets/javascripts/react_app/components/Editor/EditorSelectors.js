...
export const selectPreviewValue = state => selectEditor(state).previewValue;
...
// Select
export const selectHosts = state => selectEditor(state).hosts;
export const selectIsSearchingHosts = state =>
  selectEditor(state).isSearchingHosts;
export const selectFilteredHosts = state => selectEditor(state).filteredHosts;
